...
module.exports = class AnkiDevice {
    ...
    _getCurrentLane() {
        ...
        if( bufferedTrackId != null && bufferedTrackPos != null && trackId == bufferedTrackId ){
    ...
    _initOffset() {
        if(this.data.initOffset == undefined && ( this.data.trackId == 36 || this.data.trackId == 39 || this.data.trackId == 40) ) {
            try{
                const offset = this._getCurrentLane();
